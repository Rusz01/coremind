...
function Home_Top() {
  ...
  return (
   <>
    <div className='grid grid-row gap-6 items-center mt-10 p-5 md:grid-cols-2 lg:gap-6 lg:p-5'>
      <div className='pr-10'>
         <h1 className='text-4xl lg:text-6xl font-medium mb-5'>TURN CONVERSATIONS INTO SMART ACTIONS</h1>
      ...
      <div className="lg:w-140 w-90 mt-10 md:mt-0 mx-auto">
         <Border_Card >
            ...
            <div className="p-3 flex items-center bg-secondary-blue rounded-xl">
               <IoSearch className='inline-block mr-3 w-4 h-4 lg:w-6 lg:h-6 text-custom-blue' />
               <p className='text-md lg:text-xl text-white'>Find the date, queries ....</p>
            </div>
            <h2 className='text-md lg:text-lg font-medium text-white my-5'>KEY ELEMENTS</h2>
